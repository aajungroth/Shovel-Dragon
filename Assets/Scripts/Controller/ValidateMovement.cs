...
public class ValidateMovement : MonoBehaviour {
  ...
  public static bool IsMoveValid(Vector2 direction, GameObject entity,
  TrackModel trackModel) {
    ...
    targetPosition = entity.GetComponent<EntityModel>().GetCurrentPosition() +
      direction;
    targetPositionKey = targetPosition.x.ToString() + "," +
